...
Use this index to minimize context load. Read only the section needed for the
current task.

## Tier A: Active Canonical
...
4. [`EXTENSIBILITY_STRATEGY_2026-03-14.md`](./EXTENSIBILITY_STRATEGY_2026-03-14.md) - portability-first extension ladder for rare style behavior.
...
These are point-in-time execution records, not canonical status:

1. [`ROADMAP_SYNC_2026-02-15.md`](./ROADMAP_SYNC_2026-02-15.md)
2. [`WAVE_100_PRIORITY_BATCH_2026-02-20.md`](./WAVE_100_PRIORITY_BATCH_2026-02-20.md)
3. [`MIGRATE_ENHANCE_WAVE_STRATEGY_2026-02-21.md`](./MIGRATE_ENHANCE_WAVE_STRATEGY_2026-02-21.md)
4. [`MIGRATE_ENHANCE_WAVE_RUNBOOK_2026-02-21.md`](./MIGRATE_ENHANCE_WAVE_RUNBOOK_2026-02-21.md)
5. [`MIGRATE_ENHANCE_WAVE1_HANDOFF_2026-02-21.md`](./MIGRATE_ENHANCE_WAVE1_HANDOFF_2026-02-21.md)
...
If a Tier C doc conflicts with Tier A, Tier A is authoritative.
