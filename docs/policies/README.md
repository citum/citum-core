...
| [`AGENT_HARNESS_POLICY.md`](./AGENT_HARNESS_POLICY.md) | Keep planner, worker, reviewer, artifact, and verification boundaries repo-owned while user config handles local tools |
