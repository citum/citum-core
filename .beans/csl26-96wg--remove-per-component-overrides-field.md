...
updated_at: 2026-03-23T20:22:15Z
---

Schema-Bump: major. Remove ComponentOverride and overrides field from TemplateComponent. Fix convert-overrides-to-type-variants.py for suppression patterns, bulk-migrate styles. Blocked by spec/template-v2 merge.
...
as-is stripped 627-line style files down to ~162 lines, dropping all type-specific rendering and
collapsing fidelity from 1.0 to 0.052.
...
6. All changes in one commit (spec §2.4 constraint): schema field removal + compiler fix.
