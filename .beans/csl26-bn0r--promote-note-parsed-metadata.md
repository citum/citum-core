...
- [ ] Extend the legacy conversion helpers (reference/conversion.rs) so the parsed values populate the canonical `InputReference` fields or `extra` payloads consumed by the processor.
