---
name: styleauthor
description: "Legacy alias for style-evolve. Use it only when older docs or workflows still reference the original name."
---
...
Use `style-evolve` for new work. Keep this alias thin and do not add separate
workflow logic here.
